...
public struct Argon2i {
    public let alg = Int(crypto_pwhash_alg_argon2i13())
    public let strPrefix: String = String(cString: crypto_pwhash_argon2i_strprefix())
    ...
    public let memLimitMin: Int = Int(crypto_pwhash_argon2i_memlimit_min())
    public let memLimitMax: Int = Int(crypto_pwhash_argon2i_memlimit_max())
    public let opsLimitMin: Int = Int(crypto_pwhash_argon2i_opslimit_min())
    public let opsLimitMax: Int = Int(crypto_pwhash_argon2i_opslimit_max())
    public let opsLimitInteractive: Int = Int(crypto_pwhash_argon2i_opslimit_interactive())
    public let memLimitInteractive: Int = Int(crypto_pwhash_argon2i_memlimit_interactive())
    public let opsLimitModerate: Int = Int(crypto_pwhash_argon2i_opslimit_moderate())
    public let memLimitModerate: Int = Int(crypto_pwhash_argon2i_memlimit_moderate())
    public let opsLimitSensitive: Int = Int(crypto_pwhash_argon2i_opslimit_sensitive())
    public let memLimitSensitive: Int = Int(crypto_pwhash_argon2i_memlimit_sensitive())
